...
''' outputs : Enter  any  sentence : My name Usha
Reverse  order  of  words :  Usha is name My'''
...
# Identify  error 
list = [25 , 10.8 , 'Hyd' , True , 3 + 4j]
a , *b , c , *d , e  = list  # error due to multi star assignment
