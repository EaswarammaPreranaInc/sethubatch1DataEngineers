Q1 # Variable  number  of  arguments  demo  program
def   f1(*t):
	print(t)
	print(type(t))
	print(len(t))
...
f1([10 , 20] , (30 , 40 , 50) , {60 , 70 , 80 , 90}) #([10 , 20] , (30 , 40 , 50) , {60 , 70 , 80 , 90})  <next line>  <class 'tuple'>  <next line> 3
...
-------------------------------------------------------------------------------------------------------------------------------------------------------
Q2 # Write  a  function  to  determine  average  of  arguments  passed  from  function  call (Home  work)
def  avg(*a):
...
--------------------------------------------------------------------------------------------------------------------------------
Q3 #Write  a  function  to  concatenate  strings  passed  from  the  function  call ? (Home  work)
...
-----------------------------------------------------------------------------------------------------------------------------------
Q7 # Which  of  the  following  are  valid  ?  
...
---------------------------------------------------------------------------------------------------------------------------------
Q9 # Variable  number  of  keyword  arguments  demo  program
def   disp(**a):
	print('Results')
	print(type(a))
	print(a)
...
f2()
-----------------------------------------------------------------------------------
Q20 # global  keyword  demo  program (Home  work)
def    f1():
	x = 20
	print(x) #20
def   f2():
