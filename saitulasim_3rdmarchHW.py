...
# 7: Write  a  program  to  print  first  20  odd  numbers  with  while  loop
...
while i<21:
    ...
    i+=1
print("Bye")
# 8: Write  a  program  to  print  natural  numbers  1 , 2 , 3 .... n
...
while i<=n :
    ...
    i+=1
print("Bye")
# 9:Write  a  program  to  print  10  ,  9  ,   8  ,  ..... 1
...
'''while i>0:
    print(i)
    i-=1 '''
#10: Write  a  program  to  print  upper  and  lower  case  alphabets
...
for i in range(n):
    ...
    a=b
    b=c
#12:Write  a  program  to  search  for  'x'  in  fibonacci  series
...
#13: Write  a  program  to  determine  1.1 + 2.2 + 3.3 + .... n terms
n=int(input("Enter number of terms :"))
sum=0
...
print(sum)
#14: Write  a  program  to  determine  sum  of  first  20  even  numbers
print("Sum  of  first  20  even  number: ", end=" ")
sum=0
for i in range(21):
    sum+=i*2
print(sum)
#15: Write  a  program  to  determine  sum  of  first  20  Odd  numbers
print("Sum  of  first  20  Odd  number: ", end=" ")
sum=0
for i in range(1,21):
    sum+=2*i-1
print(sum)
#16: Write  a  program  to  determine  1 + 2 + 3 + .... + n  without  using  formula  n * (n + 1) / 2
n=int(input("Enter number of terms :"))
print("Sum:", end=" ")
sum=0
for i in range(1,n+1):
