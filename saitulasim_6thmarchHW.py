...
''' 3: Write  a  program  to  concatenate  two  strings  separated  by  space  but  swap  the  first  two  characters  of each string.
...
# 7: Character Expansion Based on Alternate Digits
