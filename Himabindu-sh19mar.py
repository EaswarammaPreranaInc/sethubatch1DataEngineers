...
f1(10, 20)          # Valid: Both arguments are positional
f1(a=30, b=40)      # Invalid: Cannot use keyword arguments for `a` and `b`
f1(50, b=60)        # Invalid: Cannot use keyword argument for `b`
f1(a=70, 80)        # Invalid: Syntax error, positional argument after keyword argument
