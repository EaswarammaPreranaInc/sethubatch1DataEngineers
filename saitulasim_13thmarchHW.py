...
'''Output: Enter the First List: [10 , 20 , 15]
           Enter the Second List: [30 , 40 , 35 , 32]
           [40, 50, 45, 42, 50, 60, 55, 52, 45, 55, 50, 47] '''
...
''' Output: Enter the First string: HYD
...
''' Output: Enter the List: [ [10 , 20] , [30 , 40 , 50] , [60 , 70 , 80 , 90]]
                            [10, 20, 30, 40, 50, 60, 70, 80, 90] '''
...
'''Output: Enter  List  : [10,20,15,18,10,20,15,10,20,19,10]
                    Mode: 10 '''
