...
#25 = a  # Error: cannot assign to literal here. Maybe you meant '==' instead of '='?
#a + b = x + y
...
a = 25
b = 25
print(a is b) # True becoz reference are same
print(a is not b) # False
print(a == b) # True becoz same objts
...
print('Two'); # Two
print('Three'); # Three
print('Hyd')  ; print('Sec')  ;  print('Cyb'); # Hyd <nl> Sec <nl> Cyb
...
#print(floor(3.5)) # Error becoz not import math module
#print(ceil(3.5)) # Error becoz not import math module
