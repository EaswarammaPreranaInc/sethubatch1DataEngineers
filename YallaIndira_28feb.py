#program1:program  to  determine  a  number  is  even  or  odd  with   if  statement
try:
...
#program2:program  to  print  month  name  for  input  month  number  by  using  if  and  elif 
try:
...
#program3:a  program  to  test  year  is  leap  year  or  not
try:
...
#program5:Write  a  program  to  convert  celsius  temperature  to  farenheit  and  vice-versa
try:
...
#program6: program  to  test  a  point  (x , y)  lies  in  1st  quadrant , 2nd  quadrant , 3rd  quadrant ,4th  quadrant , x - axis , y - axis   or  origin
try:
...
#program7: program  to  determine  largest , smallest  and  middle  of  three  numbers
try:
...
#program8:program  to  determine  three  sides  form  a  triangle  or  not
import math
try:
...
#program9:program  to  determine  roots  of  a  quadtratic  equation  a * x ^ 2 + b * x + c = 0  where  a  ! = 0
import math
try:
...
#program10:Write  a  program   to  determine  a  point (x , y)  lies  inside , outside  or  on  the  circle.
import math
try:
...
#program11:Write  a   program  to  print  day  of  the  week using match....case
try:
...
#program12:Write  a  program  to  print  digit in  words using match.....case
try:
...
#program13:Write  a  program  to  print  fibonacci  series  upto   x using while loop
try:
...
#program14:Write  a  program  to  determine  bill  amount  and  input  is  units
Units                                                      Cost
------------------------------------------------------------
