#p1: isspace()  method  demo  program 
print('\n  A\t' . isspace())  #  False
print('\n  \t' . isspace())   #  True
print('\n  7\t' . isspace())  #  False
print('\n' . isspace())       # True
...
#p3:Write  a  program  to  determine  user  input  is  alphabet , digit , white space  or  special  character
...
Reverse  String : aridni'''

p5:Write  a  program  to  reverse  order  of  words  in  the  sentence  without  slice
...
''' outputs : Enter  any  sentence : My name is Indira
Reverse  order  of  words :  Indira is name My'''
...
p7:Write  a  program  to  sort  string  in  alphabetical  order
Let  input  be  RAJESH
...
p8:Write  a  program  to  sort  string  such  that  alphabets  in  alphabetical  order  and  digits  in  ascending  order
...
#p9 :What  are  the  outputs  if  input  is   [25 , 10.8 , 'Hyd' , True] #
