...
add = lambda  x  :   x := 25 # error due to invalid syntax
'''
...
def  outer():
	def  inner():
		#nonlocal  x # error no LV x in outer function how can write nonlocal x in inner functi
		x = 20
		print(x)
	# End  of  inner  function
	inner()
	#print(x) # error due no LV x in outer function
# End  of  the  function
outer() # 20 
#print(x) # error  x id not define gobally
'''
