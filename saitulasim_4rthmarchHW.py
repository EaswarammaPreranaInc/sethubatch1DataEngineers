...
# 2:  Walrus   operator (:=)  demo  program
print(a := 25)   #25
#print(a = 25)    #error
print(a)         #25
print(a := 6 + 7) #13
...
# 5:Write  a  program to  determine  average  of  inputs  which  are  terminated  with  -1 (without  walrus  operator)
...
#6: del  operator  demo program  (Home  work)
a = 25   
print(a) #25
...
# 8: Can  multiple  objects  be  deleted  with  same  del  operator ?
a , b , c = 25 , 10.8 , 'Hyd'
