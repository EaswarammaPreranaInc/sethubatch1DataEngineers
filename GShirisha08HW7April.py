...
#print(a . _dict_)  #  'a' is not defined 
...
# End  of  class
a = c1()
print(a . _dict_) # creates an empty dictionary{}
a . x = 10
#print(a . _dict_) # adds an element to the {x:10}
a . y = 20
...
#print(a . _dict_) #{}
del   a
#print(a . _dict_) # object a doesn't exists
...
c = c3()
d = c4()
print(a) # address of '__main__.c1'
print(b)  # address of '__main__.c2'
print(c)  # address of '__main__.c3'
print(d)  # address of '__main__.c4'
print(b . _str_()) # 35
print(c . _str_()) # hyd
print(d . _str_(50)) # None <next line> 50
