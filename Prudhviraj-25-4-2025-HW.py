...
class   D(C):
	def   m1(self):
		...
		B.m1(self)           #How  to  call  method  m1()  of  class  B  in  another  way
...
class  child(parent):
	...
	def   m2(cls):
		...
		print(super().a)   #How  to  print  static  variable  'a'
	...
	def   m3():
		...
		print(child.b)     #How  to  print  static  variable  'b'
	def __del__(self):
		super().__init__()   #How  to  call  destructor  of  parent  class
