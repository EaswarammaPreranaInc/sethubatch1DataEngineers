...
#program3:
#a  program  to  test  year  is  leap  year  or  not
...
#program6:
#program  to  test  a  point  (x , y)  lies  in  1st  quadrant , 2nd  quadrant , 3rd  quadrant ,4th  quadrant , x - axis , y - axis   or  origin
try:
...
#program12:
#Write  a  program  to  print  digit in  words using match.....case
try:
