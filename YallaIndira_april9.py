...
print(b) # print type and address of the object i.e <__main__.c2 object at 0x00000205A4D76A50>
...
#end of the  class
a = f1() # Constructor
print(a) #  <__main__.f1 object at 0x0000020C37766A50>
'''
