...
f1(b = 30 , a = 40) #a:40<tab> b:40
f1(50 , 60) #error no positional arguments allowed
f1(70 , b = 80) #error no positional arguments allowed
f1(a = 15 , 25) #error due to keyword argument before positional argument
...
f1(70 , 80 , c = 90) #error due to 2 positional arguments
f1(70 , 80 , 90) #error due to 3 positional arguments
f1(c = 15 , b = 25 , 35) # error due to keyword arguments before positional argument


#3  Identify error (Home  work)
def   f1(a  , b , *): #error , there must be at least one argument after *
        pass
...
f1(a = 30 ,  b = 40) #error due to keyword arguments
f1(50 , b = 60) #error due to keyword arguments
f1(a = 70 , 80) # error due to keyword argument followed by positional argument
...
f1(a = 100 , b = 110 , 120) #error due to keyword arguments are before positional arguments 
f1(a = 130 , 140 , c = 150) #error due to keyword argument is before positional argument
f1(160 , b = 170 , 180) #error due to keyword argument is before positional argument
f1(190 , b = 200 , c = 210) # error due to b is keyword argument 
...
#6 Find outputs(Home  work)
 ...
 #def  f1(/ , a , b ,  c):#before '/' at least there should be one argument
        # pass
 #def   f2(a , b , c , *):#after '*' at least there should be one argument
         #pass
 ...
 #10 Identify  Error
 #def   f1(a = 10 ,  b ,  c = 20 ,  d):#error becoz positional argument after keyword argument
 	#pass
 ...
 #print(add(c = 100 , d = 200 , 300 , 400))#error keyword augment before positional argument
